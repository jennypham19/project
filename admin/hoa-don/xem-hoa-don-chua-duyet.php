<body>
	...
	<div class="see-bill-3">
		...
		$sql="SELECT * FROM `hoa-don` WHERE trangThai is NULL" ;
		$result=mysqli_query($open,$sql);
		include("../../connect/close.php");
		?>
		<div class="see-bill-3-1">
			...
			<table border="1px" cellspacing="0" cellpadding="0">
				...
				<?php while ($bill_3=mysqli_fetch_array($result)) { ?>
					<tr>
						<td><?php echo $bill_3["MaHoaDon"] ; ?></td>
						<td><?php echo $bill_3["TenKhachHang"]?></td>
						<td><?php echo $bill_3["SDT"]?></td>
						<td><?php echo $bill_3["SoLuongKhach"] ; ?></td>
						<td><?php echo $bill_3["NgayDat"]; ?></td>
						<td><?php echo $bill_3["GioDat"]; ?></td>
						<td><?php if($bill_3["trangThai"]==""){
							echo "<span style='color:blue;font-style:italic;'>ĐANG CHỜ</span>";;
						} ?></td>
						<?php 
						if($bill_3["trangThai"]==""){
							?>		 
							<td width="75px"><a href="duyet-hoa-don.php?maHD=<?php echo $bill_3["MaHoaDon"];?>"><button style="background: #DFC17A;">Duyệt</button></a>
								<a href="huy-hoa-don.php?maHD=<?php echo $bill_3["MaHoaDon"];?>"><button style="background: #85DAEC;">Hủy</button></a>
							</td>
							<?php
						}else{
							?>
